...
answer_1 = Answer.create!(body: 'English 1', correct: false, question_id: quest_1.id)
answer_2 = Answer.create!(body: 'France 1', correct: false, question_id: quest_1.id)
answer_3 = Answer.create!(body: 'Deutsch 1', correct: false, question_id: quest_1.id)
answer_4 = Answer.create!(body: 'Ruby 1', correct: true, question_id: quest_1.id)
